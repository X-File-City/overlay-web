...
You must be at least **13 years old** to use the Services. If you are under the age of majority in your jurisdiction, you may use the Services only with the consent of a parent or legal guardian who agrees to be bound by these Terms on your behalf.
...
- **Local browsing panels**
- **Overlay interfaces** for quick access to features

### 3.1 Local-First Architecture

**By design, the Services operate on a local-first principle.** This means:
- The **content** of your notes, chats, and browser usage (including page content, URLs visited, and any text you enter) **remains stored locally on your device**.
- We do **not** collect, transmit, or store this content on our servers.
- Your local data is your responsibility to back up and secure.
...
You may be required to authenticate during onboarding. You agree to:
...
You are solely responsible for all activity that occurs under your account, whether or not you authorized such activity. We are not liable for any loss or damage arising from your failure to comply with this section.

---

## 5. Bring Your Own API Key (BYO Key) Model

### 5.1 Current Model
Currently, certain features of the Services require you to provide your own API keys from third-party service providers (such as Groq, OpenAI, Google, or other AI/transcription providers).

### 5.2 Your Responsibilities
When using the BYO Key model:
- **You are solely responsible** for obtaining, maintaining, and securing your API keys.
- **You are solely responsible** for any charges, fees, or costs incurred through your use of third-party APIs.
- **You must comply** with the third-party provider's terms of service, acceptable use policies, and usage limits.
- **You acknowledge** that your API keys may be stored locally on your device for functionality purposes.

### 5.3 Third-Party Terms
Your use of any third-party services through the App is governed by that third party's terms of service and privacy policy, **not** by these Terms. We have no control over and assume no responsibility for:
- Third-party service availability, uptime, or reliability
- Third-party pricing changes, rate limits, or usage restrictions
- Third-party terms of service changes or policy decisions
- Any content, data handling, or privacy practices of third parties
- Any loss or damage resulting from third-party service outages or changes

### 5.4 Future Subscription Model
We may introduce subscription plans in the future that provide managed API access, removing the need for BYO keys. If introduced, such subscriptions will be subject to additional terms.
...
The Services may utilize artificial intelligence and machine learning models provided by third parties. **AI-generated outputs (including but not limited to transcriptions, smart transcriptions, and chat responses) may be inaccurate, incomplete, misleading, biased, or inappropriate.**
...
- Use the Services to **infringe** the intellectual property, privacy, publicity, or other rights of any third party
- Use the Services to **harass, abuse, defame, threaten, or intimidate** any person
- Use the Services to generate, distribute, or facilitate **spam, malware, or malicious content**
- Use the Services to **develop weapons, surveillance tools, or other harmful applications**
...
### 7.2 Enforcement
We reserve the right to investigate and take appropriate action against anyone who, in our sole discretion, violates this section. Such action may include, without limitation:
- Issuing warnings
...
### 8.1 Ownership
You retain all ownership rights to the content you create locally using the Services (notes, chat conversations, etc.). We do not claim ownership of your local content.

### 8.2 Your Responsibilities
You are solely responsible for:
- **Backing up** your device and all local data—we are not responsible for any loss of data
- **Securing** your device against unauthorized access
- **Reviewing and verifying** any outputs before relying on or sharing them
- **Determining the appropriateness** of any content you create or generate
- **Complying with all applicable laws** regarding your content and its use

### 8.3 No Professional Advice
The Services and any content generated through them do **not** constitute professional advice of any kind, including but not limited to:
- Medical, health, or psychological advice
- Legal advice
- Financial, investment, or tax advice
- Engineering or safety advice

**Always consult a qualified professional** before making decisions based on any information obtained through the Services.
...
- All trademarks, service marks, and logos
- All documentation and content we create

### 9.2 Limited License
Subject to your compliance with these Terms, we grant you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to download, install, and use the Services for your personal, non-commercial purposes.

### 9.3 Restrictions
You may not:
- Copy, modify, or create derivative works of the Services
- Distribute, sell, lease, license, or sublicense the Services
- Remove or alter any proprietary notices or labels on the Services
- Use our trademarks without prior written permission

---

## 10. Updates, Modifications, and Discontinuation

### 10.1 Service Changes
We reserve the right to:
- Modify, update, or discontinue the Services (or any part thereof) at any time, with or without notice
- Add or remove features or functionality
- Change pricing, introduce paid features, or modify subscription terms
- Impose new limits or restrictions on use

### 10.2 Updates
The Services may automatically download and install updates. You consent to such automatic updates, which may include bug fixes, security patches, feature enhancements, or other changes.

### 10.3 No Obligation
We have no obligation to:
- Maintain or support the Services indefinitely
- Provide any specific features or functionality
- Make the Services available in any particular location
...
If you provide us with any feedback, suggestions, ideas, comments, or other input regarding the Services ("Feedback"), you hereby grant us a non-exclusive, worldwide, perpetual, irrevocable, royalty-free, fully sublicensable right and license to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, display, and otherwise exploit such Feedback for any purpose without compensation, attribution, or notice to you.
...
- **WARRANTIES THAT ANY CONTENT OR INFORMATION OBTAINED THROUGH THE SERVICES WILL BE ACCURATE OR RELIABLE**
...
- Any third-party services, APIs, or products accessed through the Services
- Any AI-generated content, including its accuracy, appropriateness, or legality
...
- **DAMAGES RESULTING FROM ANY THIRD-PARTY SERVICES OR APIs**
...
### 14.2 Liability Cap
**OUR TOTAL CUMULATIVE LIABILITY TO YOU FOR ALL CLAIMS ARISING FROM OR RELATING TO THESE TERMS OR THE SERVICES SHALL NOT EXCEED THE GREATER OF:**
- **THE AMOUNTS YOU HAVE PAID TO US FOR THE SERVICES IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR**
...
- Any content you create, submit, or generate through the Services
- Your use of AI-generated content
- Your use of third-party APIs or services through the Services
- Any dispute between you and any third party
- Any negligent or wrongful conduct by you

### 15.2 Procedure
We will provide you with prompt written notice of any claim subject to indemnification (provided that failure to provide such notice shall not release you from your indemnification obligations except to the extent you are materially prejudiced). We reserve the right, at our own expense, to assume the exclusive defense and control of any matter subject to indemnification by you, in which event you will cooperate with us in asserting any available defenses.
...
- Created risk or possible legal exposure for us
- Engaged in fraudulent, abusive, or illegal activity
- Failed to pay any applicable fees

### 18.3 Effect of Termination
Upon termination:
- Your right to use the Services will immediately cease
- You must cease all use of the Services and delete any copies of the App
- Your locally stored data remains on your device (we do not have access to delete it)
- We may delete any account information we hold

### 18.4 Survival
The following sections shall survive termination: Sections 6 (AI-Generated Content Disclaimer), 8 (Your Content and Data), 9 (Intellectual Property), 12 (Feedback), 13 (Disclaimer of Warranties), 14 (Limitation of Liability), 15 (Indemnification), 16 (Dispute Resolution), 17 (Governing Law), and any other provisions that by their nature should survive.
...
You agree to comply with all applicable export laws and regulations. You may not use, export, or re-export the Services except as authorized by United States law and the laws of the jurisdiction in which the Services were obtained.

---

## 20. Changes to These Terms

We may modify these Terms at any time by posting the revised Terms on our website or within the App. The "Last updated" date at the top indicates when the Terms were last revised.
...
For material changes, we will make reasonable efforts to notify you (e.g., via email or in-app notification) at least **fifteen (15) days** before the changes take effect, unless the changes are required by law or relate to new features.
